    ...
    return (
        <div className="container mx-auto max-w-3xl p-4">
            ...
            <div className="flex flex-row items-center text-center mb-8 space-x-12">
                <Avatar>
                    <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" className="rounded-full w-28 h-28 object-cover" />
            ...
            <PostModal
                isOpen={isModalOpen}
                onClose={closeModal}
                postContent="This is the content of the post on the Profile page."
            />
