    ...
    return (
        <div className="container mx-auto max-w-3xl p-4">
            ...
            <div className="flex flex-row items-center text-center mb-8 space-x-12">
                <Avatar>
                    <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" className="rounded-full w-32 h-32 object-cover" />
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex flex-row space-x-12 text-base text-gray-600 mt-2">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        {posts.map((post) => (
                            <img
                                ...
                                src={post.src}
                                alt={post.alt}
                                className="w-[264px] object-cover"
                            />
                        ))}
                    </div>
                </ScrollAreaViewport>
